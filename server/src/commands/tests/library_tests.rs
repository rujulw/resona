...
use crate::commands::{
    build_shell_state, get_album_with_database, list_albums_with_database,
    load_playback_track_with_database, query_library_with_database,
...
#[test]
fn album_commands_return_grouped_summaries_and_detail_tracks() {
    let database_state = test_database_state();
