...
mod tests {
    use super::{
        ...
        LOCAL_PLAYLISTS_FOUNDATION_MIGRATION, PLAYLIST_ARTWORK_MIGRATION, TABLE_ANALYSIS_RESULTS,
        TABLE_CACHE_ENTRIES, TABLE_LIBRARY_ROOTS, TABLE_PLAYLISTS, TABLE_PLAYLIST_ENTRIES,
