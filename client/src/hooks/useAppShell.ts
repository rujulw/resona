...
export function useAppShell() {
  ...
  return {
    ...
    volumeLevel: playbackCoordinator.volumeLevel,
    isMuted: playbackCoordinator.isMuted,
    handleVolumeChange: playbackCoordinator.handleVolumeChange,
    handleMuteToggle: playbackCoordinator.handleMuteToggle,
