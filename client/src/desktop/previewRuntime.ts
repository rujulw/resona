...
export function getPreviewExtractedScore(sourcePath: string): ScoreDetailPayload {
  return {
    sourcePath,
    sourceName: sourcePath.split("/").pop() ?? "preview.musicxml",
    sourceFormat: "musicxml",
    title: "midnight etude",
    composer: "preview ensemble",
    tempoBpm: 88,
    timeSignature: "4/4",
    keySignature: "A minor",
    totalBeats: 8,
    totalSeconds: 8 * (60 / 88),
    partCount: 1,
    measureCount: 2,
    noteCount: 6,
    parts: [
    ...
    events: [
      ...
      },
      {
        ...
        startBeats: 4,
        durationBeats: 2,
        startSeconds: 4 * (60 / 88),
        durationSeconds: 2 * (60 / 88),
        isChordTone: false,
      },
      {
        id: "evt-6",
